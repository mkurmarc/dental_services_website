...
function HomeCardOne() {
  return (
    <section className="home_card_one--container">
      ...
      <p>
        The next evolutionary step in occusal splints has arrived. Digitally
        designed and 3-D printed for maximum precision.
      </p>
...
function HomeCardThree() {
  return (
    <section className="home_card_three--container">
      <img id="home_card_three--img" src={keysplit_soft}></img>
      <h3>KEYSPLINT SOFT</h3>
      <h2>ELASTIC MEMORY BENEFITS ALL</h2>
      <p>
        By simply warming in water, placement become easy, fast and painless.
        Less hassle and chairside time. Increased patient comfort.{" "}
      </p>
    </section>
  );
}
